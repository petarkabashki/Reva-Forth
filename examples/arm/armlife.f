...
: buttonpush ( hwnd uMsg wParam lParam -- )
   over case
      quit-id caseof 0 PostQuitMessage drop endof 
...
: lifefunc
   lfunc @ case 
      0 caseof pass endof \ do a pass of life
      hline-id  caseof hline endof         
      vline-id caseof vline endof         
      square-id caseof square endof         
      cross-id caseof cross endof         
      pento-id caseof pentomino endof         
      clear-id caseof clear-field endof
   endcase
 	0 lfunc ! 
;
...
:: 
   ...
   0 cb-param  1 cb-param  2 cb-param  3 cb-param  ( -- hwnd uMsg wParam lParam ) \ get the params
 	2 pick case                             \ get uMsg
		WM_PAINT caseof                            \ process WM_PAINT message
